...
const Footer = ({
  ...
  return (
    <div className="flex justify-between">
      <button
        type="button"
        className="text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 focus:outline-none dark:focus:ring-purple-800 mt-3"
      ...
      <nav aria-label="Page navigation example">
        <ul className="items-center -space-x-px flex justify-center mt-3 cursor-pointer">
          ...
          {numbers.map((e, idx) => {
            return (
              <li key={idx} onClick={() => changePage(e)}>
                <div
                  className={
                    currentPage === e
                      ...
                      : "px-3 py-2 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white max-[320px]:hidden"
                  }
                >
                  {e}
                </div>
